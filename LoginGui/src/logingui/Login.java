...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPasswordField1.setFont(new java.awt.Font("Tahoma", 2, 24)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            if(username.contains("Anish") && password.contains("anish"))
            {
                JOptionPane.showMessageDialog(jTextField1, "Welcome"+username);
                dispose();
                Sucessfully_login sc=new Sucessfully_login();
                sc.setVisible(true);
            }
            else
            {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        JOptionPane.showMessageDialog(rootPane,"Do you want to Register " );
